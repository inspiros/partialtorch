...
#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH4(NAME, SELF_T, ARG1, ARG2, ARG3, ARG4) \
PARTIALTORCH_API c10::intrusive_ptr<TensorMaskedPair> NAME(SELF_T self, ARG1, ARG2, ARG3, ARG4);

#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH5(NAME, SELF_T, ARG1, ARG2, ARG3, ARG4, ARG5) \
PARTIALTORCH_API c10::intrusive_ptr<TensorMaskedPair> NAME(SELF_T self, ARG1, ARG2, ARG3, ARG4, ARG5);
...
#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OP__WITH4(NAME, SELF_T, ARG1, ARG2, ARG3, ARG4) \
PARTIALTORCH_API c10::intrusive_ptr<TensorMaskedPair> NAME##_(SELF_T self, ARG1, ARG2, ARG3, ARG4);
...
#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH4(NAME, ARG1, ARG2, ARG3, ARG4) \
PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH4(NAME, const_intrusive_ptr_arg_t<TensorMaskedPair>, ARG1, ARG2, ARG3, ARG4)

#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH5(NAME, ARG1, ARG2, ARG3, ARG4, ARG5) \
PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH5(NAME, const_intrusive_ptr_arg_t<TensorMaskedPair>, ARG1, ARG2, ARG3, ARG4, ARG5)
...
#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS__FORALL_TENSOR_OVERLOADS_WITH4(NAME, ARG1, ARG2, ARG3, ARG4) \
PT_DECLARE_ONE2ONE_PASSTHROUGH_OP__WITH4(NAME, intrusive_ptr_arg_t<TensorMaskedPair>, ARG1, ARG2, ARG3, ARG4)
...
#define PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_AND_OPS__FORALL_TENSOR_OVERLOADS_WITH4(NAME, ARG1, ARG2, ARG3, ARG4) \
PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH4(NAME, ARG1, ARG2, ARG3, ARG4)                  \
PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS__FORALL_TENSOR_OVERLOADS_WITH4(NAME, ARG1, ARG2, ARG3, ARG4)
...
namespace partialtorch {
    namespace ops {
        ...
        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH4(
                diagonal, at::Dimname outdim, at::Dimname dim1, at::Dimname dim2, int64_t offset = 0)
        ...
        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH2(
                select, at::Dimname dim, int64_t index)
        ...
        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH3(
                flatten, int64_t start_dim, int64_t end_dim, at::Dimname out_dim)

        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH3(
                flatten, at::Dimname start_dim, at::Dimname end_dim, at::Dimname out_dim)

        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH2(
                flatten, at::DimnameList dims, at::Dimname out_dim)

        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH2(
                unflatten, int64_t dim, c10::SymIntArrayRef sizes)

        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH3(
                unflatten, at::Dimname dim, c10::SymIntArrayRef sizes, at::DimnameList names)
        ...
        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH2(
                transpose, at::Dimname dim0, at::Dimname dim1)
        ...
        PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH5(
                col2im,
...
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH4
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OP_WITH5
...
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OP__WITH4
...
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH4
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_FORALL_TENSOR_OVERLOADS_WITH5
...
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS__FORALL_TENSOR_OVERLOADS_WITH4
...
#undef PT_DECLARE_ONE2ONE_PASSTHROUGH_OPS_AND_OPS__FORALL_TENSOR_OVERLOADS_WITH4
