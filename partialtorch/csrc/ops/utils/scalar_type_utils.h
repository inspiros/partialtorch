...
#define AT_FORALL_TYPES(_)  \
    ...
    _(at::Half, Half, HALF_MIN, HALF_MAX, HALF_LB, HALF_UB, HALF_QNAN, HALF_SNAN) /* 5 */ \
    ...
    _(at::BFloat16, BFloat16, BFLOAT16_MIN, BFLOAT16_MAX, BFLOAT16_LB, BFLOAT16_UB, BFLOAT16_QNAN, BFLOAT16_SNAN) /* 9 */
...
#define SPECIALIZE_ScalarTypeLimits(cpp_type, scalar_type, min_value, max_value, lb_value, ub_value, qnan_value, snan_value)  \
template <>                                                                                                                   \
...
#define SPECIALIZE_CPPTypeLimits(cpp_type, _, min_value, max_value, lb_value, ub_value, qnan_value, snan_value)  \
template <>                                                                                                      \
